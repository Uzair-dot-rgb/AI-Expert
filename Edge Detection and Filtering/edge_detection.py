...
def interactive_edge_detection(image_path):
    """Interactive edge detection using Canny algorithm with trackbars."""
    ...
    print("3. Laplacian Edge Dectection")
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("Adjust the thresholds for Canny Edge Detection: ")
            ...
            print("Adjust the kernel size for Guassian Smoothing (must be odd): ")
            kernel_size = int(input("Enter kernel size: "))
            blurred_image = cv2.GuassianBlur(image, (kernel_size, kernel_size), 0)
            display_image("Guassian Smoothing", blurred_image)
        elif choice == "5":
            print("Adjust the kernel size for Median Filtering (must be odd): ")
            kernel_size = int(input("Enter kernel size: "))
...
interactive_edge_detection("camera.jpeg")