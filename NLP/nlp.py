...
def ask_hf(headline: str):
    pay_load = {"inputs": headline, "parameters": {"candidate_labels": TOPICS}}
    r = requests.post(API_URL, headers = HEADERS, json = pay_load, timeout = 30)
    if not r.ok:
...
def main():
    print("Welcome! Type a news headline and I'll gues the Topic.")
