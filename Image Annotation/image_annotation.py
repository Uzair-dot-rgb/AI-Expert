...
cv2.rectangle(image, top_left1, bottom_right1, (0, 255, 255), 3)
...
cv2.rectangle(image, top_left2, bottom_right2, (255, 0, 255), 3)
...
cv2.circle(image, (center1_x, center1_y), 15, (0, 255, 0), -1)
cv2.circle(image, (center2_x, center2_y), 15, (0, 255, 0), -1)
...
cv2.arrowedLine(image, arrow_end, arrow_start, (255, 255, 0), 3, tipLength = 0.05)

height_label_position = (arrow_start[0] - 150, (arrow_start[1] + arrow_end[1]) // 2)
cv2.putText(image, f"Height: {height}px", height_label_position, font, 0.8, (255, 255, 0), 2, cv2.LINE_AA)
