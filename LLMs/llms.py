...
if __name__ == "__main__":
    ...
    if not user_text:
        ...
        model_choice = input("Model name (leave black for default): ").strip()
        if not model_choice:
        ...
        summary = summarize_text(user_text, min_length, max_lenght, model_name = model_choice)
        if summary:
            print(Fore.GREEN + Style.BRIGHT + f"\n???? AI Summarization output for {user_name}")
